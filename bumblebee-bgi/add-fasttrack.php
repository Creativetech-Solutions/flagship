...
if (isset($_POST['addreservation'])) {
    ...
    if(isset($_POST['arr_ServiceOnly']) && $_POST['arr_ServiceOnly']){
        $arrServiceOnly = true;
    }else{
    ...
    $res_hotel = QuoteSmart(@$_POST['res_hotel']);
   ...
   // $teens = QuoteSmart(@$_POST['teens']);
    ...
    if (isset($_POST['arr_transport'])) {
        $arr_transport = QuoteSmart($_POST['arr_transport']);
    } else {
        $arr_transport = '';
    }
...
//    print_r($guestsArray);
    ...
    if (!empty($guestsArray)) {
        foreach ($guestsArray as $guest) {
            $sqlGuestQuery = "INSERT INTO bgi_guest " .
                "(ref_no_sys, title_name, first_name, last_name, adult,teen_age, child_age, infant_age, pnr) " .
                "VALUES ('$fsref', '" . $guest['guestTitle'] . "', '" . $guest['guestFirstName'] . "', '" . $guest['guestLastName'] . "', '" . (!empty($guest['guestAdult']) ? 1 : 0) . "',  '" . $guest['guestTeenAge']. "', '" . $guest['guestChildAge'] . "', '" . $guest['guestInfantAge'] . "', '" . $guest['guestPNR'] . "')";
    ...
    if($arrServiceOnly !== true){
        $sql_9 = "INSERT INTO bgi_departures " .
            "(ref_no_sys, dpt_date, dpt_time, dpt_flight_no, flight_class, dpt_transport, dpt_driver, dpt_vehicle, dpt_pickup, dpt_dropoff, dpt_pickup_time, dpt_transport_notes, dpt_main, dpt_jet_center, fast_track, dpt_vouchers, dpt_cold_towel, dpt_bottled_water, dpt_infant_seats, dpt_child_seats, dpt_booster_seats,dpt_client_reqs) " .
            "VALUES ('$fsref', '$dpt_date', '$dpt_time', '$dpt_flight_no', '$dpt_flight_class', '$dpt_transport', '$dpt_driver', '$dpt_vehicle_no', '$dpt_pickup', '$dpt_dropoff', '$pickup_time', '$dpt_transport_notes', '$dpt_main','$jetCenter', '$ftres','$dpt_vouchers','$dpt_cold_towels','$dpt_bottled_water', '$dpt_infant_seats', '$dpt_child_seats','$dpt_booster_seats','$dpt_client_reqs')";
    ...
    if(isset($sysRefNo) && !empty($sysRefNo))
        ...
        header('Location: add-fasttrack.php?ok=1&sysRef='.$sysRefNo);
    else
        //echo "<script>window.location='add-fasttrack.php?ok=1'</script>";
        header('Location: add-fasttrack.php?ok=1');
...
<style type="text/css">
    ...
    input[type="number"] { width:150px!important; padding:5px; }
    .guest-fields input[type="number"]{width:190px!important; padding:5px;}
        ...
        <div class="row">
           ...
           <input type="text" style="height:0;width:0;border:none" class="triggerTourOp" />                            
                            ...
                            <div class="form-group col-xs-7"><!-- reference number field -->
                                ...
                                <input type="text" class="form-control" placeholder="reference number" id="tour-ref-no" name="tour_ref_no" value="" style="text-transform: none">
                            ...
                            <div class="form-group">
                                <div class="form-inline col-xs-9"><!-- number of persons traveling -->
                                   ...
                                   <!-- <input type="number" min=0 max=99 class="left20 form-control" id="teens"
                                   name="teens" value="" placeholder="Select # of Teens"> Teen(s) -->
                            ...
                            <div class="form-group col-xs-7"><!-- dropoff location selection -->
                                ...
                                <select class="form-control dropSelect" id="res_hotel" name="res_hotel">
                                    <?php echo $opt->ShowHotelLocations(); ?>
                                </select>
                            </div>
                            <div class="form-group">
                                <div class="col-xs-7">
                            ...
                            <div id="guestmain">
                                ...
                                <div class="form-group">
                                    <div class="form-inline col-xs-12">
                                        ...
                                        <label class="left20">First name</label> 
                                        <input type="text" class="form-control right20 text-capitalize"
                                ...
                                <div class="form-group">
                                    <div class="form-inline col-xs-8 guest-fields"><!-- guest first name / guest last name fields -->
                                        ...
                                        <input type="number" min=12 max=17 class="form-control" id="teen_age"
                                               name="teen_age[]" value="" placeholder="Teen - 12 yrs - 17 yrs" style="width:170px">Years
                                        <input type="number" min=0 max=11 class="form-control" id="child_age"
                                               name="child_age[]" value="" placeholder="Child - 13 months - 11 yrs" style="width:170px">
                                        Years
                                    <div class="clearfix"></div>
                                        <input type="number" min=0 max=23 class="left20 form-control" id="infant_age"
                                               name="infant_age[]" value="" placeholder="Infant - 12 months or less" style="width:170px;margin-left:69px">
                                        Months
                                        <input type="number" min=0 max=23 class="left20 form-control" id="totalGuests"
                                               name="totalGuests" value="" placeholder="Guests Total No" style="width:170px"> Guests
                                    ...
                                    <br><br>
                                        ...
                                        <input type="number" min=0 class="left20 form-control" id="price"
                                               name="supplier_price" placeholder="Price" step="0.01">&nbsp;  &nbsp;
                                               =
                            ...
                            <div class="dpt_clientreqs reqs-box">
                                <div class="form-group col-xs-7">
                                    <?php
                                    $section = 'fsft';
                                    $dptclient_reqs = "dpt_client_reqs";
                                     include('clientreqs_select.php'); ?>
                                    <span
                                        class="help-block"> Select one (1) or multiple Airport/Hotel requirements</span>
                                </div>
                                <div class="form-group">
                                    <div class="form-inline col-xs-9">
                                        ...
                                        <input type="number" min=0 max=99 class="right20 form-control numericCol" id="cold-towels" name="dpt_cold_towels" value="" placeholder="Cold Towels">
                                        <label class="right20">Bottled Water</label>
                                        <input type="number" min=0 max=99 class="right20 form-control numericCol" id="bottled-water" name="dpt_bottled_water" value="" placeholder="Bottled Water">
                                        <label class="right20">Vouchers</label>
                                        <input type="number" min=0 max=99 class="form-control numericCol" id="vouchers" name="dpt_vouchers" value="" placeholder="Vouchers">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="form-inline col-xs-9">
                                        <label class="right20">Infant Seats</label>
                                        <input type="number" min=0 max=99 class="right20 form-control numericCol" id="infant-seats" name="dpt_infant_seats" value="" placeholder="Infant Seats">
                                        <label class="right20">Child Seats</label>
                                        <input type="number" min=0 max=99 class="right20 form-control numericCol" id="child-seats" name="dpt_child_seats" value="" placeholder="Child Seats">
                                        <label class="right20">Booster Seats</label>
                                        <input type="number" min=0 max=99  class="form-control numericCol" id="booster-seats" name="dpt_booster_seats" value="" placeholder="Booster Seats">
                                    </div>
                                </div>
                            </div>
                                <div class="clearfix"></div>
