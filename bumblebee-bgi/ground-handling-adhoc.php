                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="col-xs-12 marginBotBox">
                                        ...
                                        <input type="hidden" name="R.id::Id" value="1" />
                                            ...
                                            <li class="list-group-item">
                                                <input type="checkbox" value="1" name="R.G.cell::Guest_Cell" <?=in_array('R.G.cell::Guest_Cell', $selectedCheckBoxesNames)?'checked':''?>/>
                                                <strong>Guest Cell</strong>
                                            </li>
                                            <?php } ?>
                                            <li class="list-group-item">
                                            ...
                                            <?php if($_REQUEST['sect'] == 'fsft' || $_REQUEST['sect'] == 'all'){ ?>
                                                ...
                                                <li class="list-group-item">
                                                    <input type="checkbox" value="1" id="client" name="R.tour_operator::Client" <?=in_array('R.tour_operator::Client', $selectedCheckBoxesNames)?'checked':''?>/> 
                                            ...
                                            <?php } if($_REQUEST['sect'] == 'gh'){?>
                                               ...
                                               <?php  } ?>
                                                ...
                                                <?php /* ?> <li class="list-group-item">
                                                        <input class="a_c_i" type="checkbox" value="1" id="teen" name="R.teen::Teen" <?=in_array('R.teen::Teen', $selectedCheckBoxesNames)?'checked':''?>/> 
                                                <strong># of Teens</strong>
                                                </li> <?php */ ?>
                                                <li class="list-group-item">
                                            ...
                                            <?php } ?>
                                                ...
                                                <li class="list-group-item">
                                                    <input type="checkbox" value="1" id="sup_total_amount" name="R.sup_total_amount::$_Total" <?=in_array('R.sup_total_amount::$_Total', $selectedCheckBoxesNames)?'checked':''?>/> 
                                                <strong>$ Total</strong>
                                                </li>
                                                <li class="list-group-item">
                                     ...
                                     <div class="col-xs-12 marginBotBox guestOptions">
                                        ...
                                        <ul class="list-group">
                                            ...
                                            <li class="list-group-item">
                                                <input type="checkbox" value="1" name="R.G.teen_age::Guest_Teen_Age" <?=in_array('R.G.teen_age::Guest_Teen_Age', $selectedCheckBoxesNames)?'checked':''?>/>
                                                <strong>Teen</strong>
                                            </li>
                                            <li class="list-group-item">
                                ...
                                <div class="col-md-4">
                                    <div class="col-sm-12 col-xs-12 marginBotBox" >
                                        ...
                                        <ul class="list-group">
                                            ...
                                            <?php } ?>
                                            <li class="list-group-item">
                                                <input type="checkbox" value="1" name="R.A.client_reqs::Additional_Requirements" <?=in_array('R.A.client_reqs::Additional_Requirements', $selectedCheckBoxesNames)?'checked':''?> />
                                    ...
                                    <div class="col-sm-12 col-xs-12 marginBotBox" >
                                        ...
                                        <ul class="list-group">
                                            ...
                                            <li class="list-group-item">
                                                <input type="checkbox" value="1" id="hotel_rep" name="R.hotel_rep::Hotel_Rep" <?=in_array('R.hotel_rep::Hotel_Rep', $selectedCheckBoxesNames)?'checked':''?>/> 
                                                <strong>Hotel Rep</strong>
                                            </li>
                                        </ul>
                                    </div>
                                    <?php }?>
                                ...
                                <div class="col-md-4 marginBotBox">
                                    ...
                                    <div class="col-sm-12 col-xs-12 marginBotBox" >
                                     ...
                                     <div class="col-sm-12 col-xs-12 marginBotBox" >
                                        <h4><strong>Additional Hotels</strong></h4>
                                        <label for="selectAllAddTransport"><input type="checkbox" class="selectAllCheckboxes" id="selectAllAddTransport">Select All</label>
                                        <ul class="list-group">
                                            <li class="list-group-item">
                                                <input type="checkbox" value="1" name="R.AHL.name::Additional_Hotel" <?=in_array('R.AHL.name::Additional_Hotel', $selectedCheckBoxesNames)?'checked':''?> />
                                                <strong>Hotel Name</strong>
                                            </li>
                                            <li class="list-group-item">
                                                <input type="checkbox" value="1" name="R.AH.hotel_checkin::Additional_Hotel_CheckIn_Dt" <?=in_array('R.AH.hotel_checkin::Additional_Hotel_CheckIn_Dt', $selectedCheckBoxesNames)?'checked':''?> />
                                                <strong>Hotel Check In Date</strong>
                                            </li>
                                            <li class="list-group-item">
                                                <input type="checkbox" value="1" name="R.AH.no_of_rooms::Ad_Hotel_No_of_Rooms" <?=in_array('R.AH.no_of_rooms::Ad_Hotel_No_of_Rooms', $selectedCheckBoxesNames)?'checked':''?> />
                                                <strong>Number of Rooms</strong>
                                            </li>
                                            <li class="list-group-item">
                                                <input type="checkbox" value="1" name="R.AHR.room_type::Ad_Hotel_Room_Type" <?=in_array('R.AHR.room_type::Ad_Hotel_Room_Type', $selectedCheckBoxesNames)?'checked':''?> />
                                                <strong>Room Type</strong>
                                            </li>
                                            <li class="list-group-item">
                                                <input type="checkbox" value="1" name="R.AH.room_no::Ad_Hotel_Room_No" <?=in_array('R.AH.room_no::Ad_Hotel_Room_No', $selectedCheckBoxesNames)?'checked':''?> />
                                                <strong>Room Number</strong>
                                            </li>
                                            <li class="list-group-item">
                                                <input type="checkbox" value="1" name="R.AH.room_lname::Ad_Hotel_Room_Last_Name" <?=in_array('R.AH.room_lname::Ad_Hotel_Room_Last_Name', $selectedCheckBoxesNames)?'checked':''?> />
                                                <strong>Last Name On Room</strong>
                                            </li>
                                            <li class="list-group-item">
                                                <input type="checkbox" value="1" name="R.AH.hotel_notes::Additional_Hotel_Notes" <?=in_array('R.AH.hotel_notes::Additional_Hotel_Notes', $selectedCheckBoxesNames)?'checked':''?> />
                                                <strong>Hotel Notes</strong>
                                            </li>
                                        </ul>
                                    </div>
                                    ...
                                    <div class="col-sm-12 col-xs-12 marginBotBox" >
                                        ...
                                        <ul class="list-group">
                                            <li class="list-group-item">
                                                <input type="checkbox" value="1" name="R.DT.transport_mode::Additional_Dpt_Transport_Mode" <?=in_array('R.DT.transport_mode::Additional_Dpt_Transport_Mode', $selectedCheckBoxesNames)?'checked':''?> />
                                                <strong>Transport Mode</strong>
                                            </li>
                                            <li class="list-group-item">
                                                <input type="checkbox" value="1" name="R.DTD.name::Additional_Dpt_Transport_Supplier" <?=in_array('R.DTD.name::Additional_Dpt_Transport_Supplier', $selectedCheckBoxesNames)?'checked':''?> />
                                                <strong>Transport Supplier</strong>
                                            </li>
                                            <li class="list-group-item">
                                                <input type="checkbox" value="1" name="R.DTV.name::Additional_Dpt_Vehicle" <?=in_array('R.DTV.name::Additional_Dpt_Vehicle', $selectedCheckBoxesNames)?'checked':''?> />
                                                <strong>Vehicle</strong>
                                            </li>
                                        </ul>
                                    </div>
...
<div class="modal fade " id="reportDateRangeModal" tabindex="-1" role="dialog" aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="row">
                    ...
                    <div class="form-group">
                        <label for="reportrangeModalPicker" style="display: block;">Arrival Date Filter</label>
                        <div id="reportrangeModalPicker" class="dtrange date_error" >
                            <span></span><b class="caret"></b>
                        </div>
                    </div>
                </div>
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-primary" id="generateSavedReport">Generate</button>
...
<script type="text/javascript">
    $(function(){
        ...
        $('#generateReportBtn').on('click',function(){
            ...
            // get lenth
            var fromDate = $(".range_inputs").eq(1).find("div.daterangepicker_start_input > input#max").val();
            var toDate = $(".range_inputs").eq(1).find("div.daterangepicker_end_input > input#min").val();
    ...
    $(function(){
        ...
        /* reportrange */
        if($("#reportrange,#reportrangeModalPicker").length > 0){
            $("#reportrangeModalPicker").daterangepicker({
                ...
                var modal = $(this)[0].element[0].id;
                if(modal && modal === 'reportrangeModalPicker'){ //If Belongs to the Modal
                    console.log(start.format('MMMM D, YYYY'));
                    $('#reportDateRangeModal').find('#startDate').val(start.format('YYYY-MM-DD'));
                    $('#reportDateRangeModal').find('#endDate').val(end.format('YYYY-MM-DD'));
                }
                $('#reportrange span,#reportrangeModalPicker span').html(start.format('MMMM D, YYYY') + ' - ' + end.format('MMMM D, YYYY'));
            });
            ...
            if(isset($dateRangeText) and !empty($dateRangeText)){
                ...
                echo "$(\"#reportrangeModalPicker span\").html('".$dateRangeText."');";
                echo "console.log('".$dateRangeText."')";
            }else{
                echo "$(\"#reportrange span\").html('--Select Date Range--');";
                echo "$(\"#reportrangeModalPicker span\").html('--Select Date Range--');";
            }
            ?>
        }
        ...
        $('.reportBtn').on('click',function(e){
            e.preventDefault();
            $('#reportDateRangeModal').modal({
                backdrop: 'static',
                keyboard: false
            });
            var reportModal = $('#reportDateRangeModal');
            reportModal.find('#reportID').val($(this).attr('data-id'));
        ...
        $('#generateSavedReport').on('click',function(e){
            ...
            var fromDateAndToDate = '&fromDate='+startDate+'&toDate='+endDate;
            var data = {
                report_id:modal.find('#reportID').val(),
                sect:'<?=$_REQUEST['sect']?>',
                fromDate:startDate,
                toDate:endDate
            };
