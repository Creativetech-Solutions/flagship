                                            ...
                                            <tr>
                                                ...
                                                <?php
                                                    foreach($resultReservations as $key=>$row){
                                                        $arrTime = '00:00';
                                                        if(isset($row['ArrTime']) && !empty($row['ArrTime'])){
                                                            $arrTimeID = $row['ArrTime'];
                                                           $row_in = mysql_fetch_row(mysql_query("SELECT * FROM bgi_flighttime WHERE id_fltime = '$arrTimeID'"));
                                                           if(isset($row_in[2])) $arrTime = $row_in[2];
                                                        }
                                                ...
                                                if(substr($selectedResType, 0, -1) != 'Arrival')
                                                                echo "<td>".$arrTime."</td>";
