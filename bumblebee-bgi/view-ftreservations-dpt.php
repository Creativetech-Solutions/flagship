                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <select name="menu" onChange="window.document.location.href=this.options[this.selectedIndex].value;" value="GO" class="form-control">
                                ...
                                <option value="view-ftreservations-arr_new.php">Arrivals</option>-reservations-dpt.php">Departures</option>
                                    ...
                                    <table id="res-arrivals" class="table table-hover display">
                                        ...
                                        <?php
                                            while($row = mysql_fetch_array($reservations)) {
                                                ...
                                                echo '<tr>
                                                        <td><a href="ftreservation-details.php?id=' . $id . '"><i class="fa fa-search" data-toggle="tooltip" data-placement="top" title="View / Edit reservation"></i></a></td>
                                                        <td>' . $title_name . '</td>
                                                        <td>' . $first_name . '</td>
                                                        <td>' . $last_name . '</td>
                                                        <td>' . $conf_num . '</td>
