                    ...
                    <li style="margin-top: 10px; margin-left: 15px;">
                        <form>
                            <select id="destination_select" class="form-control">
                                <option value="<?php echo $uri;?>bumblebee-bgi/" selected>BGI - Barbados</option>
                                <option value="<?php echo $uri;?>bumblebee-anu/" disabled>ANU - Antigua</option>
                                <option value="<?php echo $uri;?>bumblebee-gnd/" disabled>GND - Grenada</option>
                                <option value="<?php echo $uri;?>bumblebee-skb/" disabled>SKB - St.Kitts & Nevis</option>
                            </select>
                            <script>
                                $(function(){
