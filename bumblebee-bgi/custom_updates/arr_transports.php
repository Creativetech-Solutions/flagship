...
<div class="arr_transport_div transport-div" <?=($maxReached === true)?' style="margin-bottom:30px;overflow:hidden;"':''?>>
...
<div class="form-group col-xs-4"><!-- available driver selection -->
    ...
    <select class="form-control arr_driver driver" id="arr<?=isset($arrivalID)?$arrivalID:''?>-driver" name="arr<?=isset($arrivalID)?$arrivalID:''?>_driver[]" disabled="disabled">
...
<div class="form-group col-xs-3"><!-- vehicle # selection -->
    ...
    <select class="form-control left20 arr_vehicle vehicle" id="arr<?=isset($arrivalID)?$arrivalID:''?>-vehicle-no" name="arr<?=isset($arrivalID)?$arrivalID:''?>_vehicle_no[]" disabled="disabled">
