...
<div class="additional-transfer-div" id="additional-transfer-<?=$divID?>">
    ...
    <div class="form-group col-xs-5"> <!-- transport mode field -->
        ...
        <div class="left20">
            ...
            $result = mysql_query($sql);
            echo '<select class="form-control transport-mode" id="'.$transfer_transport.'" name="'.$transfer_transport.'">';
            while ($row = mysql_fetch_array($result)) {
    ...
    <div class="form-group col-xs-7"><!-- dropoff location selection -->
        ...
        <?php
          /*  $sql = "SELECT * FROM bgi_location ORDER BY name ASC";
            $result = mysql_query($sql);
            echo '<select class="form-control select " id="'.$transfer_dropoff.'" name="'.$transfer_dropoff.'">
            ...
            echo '<input type="text" class="form-control" name="'.$transfer_dropoff.'" />';
         ?>
    </div>
    <div class="clearfix"></div>
