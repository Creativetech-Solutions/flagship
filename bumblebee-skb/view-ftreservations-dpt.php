...
$reservationQuery = "SELECT * FROM skb_reservations R INNER JOIN skb_departures D on R.ref_no_sys = D.ref_no_sys WHERE (R.fast_track = 1 or D.fast_track = 1) AND R.status = 1";
