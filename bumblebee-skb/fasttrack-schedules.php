...
//$reservations = mysql_query("SELECT * FROM skb_reservations WHERE status = 1 AND fast_track = 1 AND assigned = 1 AND yearweek(arr_date) = yearweek(curdate())");
//$reservations = mysql_query("SELECT * FROM skb_reservations WHERE status = 1 AND fast_track = 1 AND assigned = 1");


//Grab all reservation info
$reservationQuery = "SELECT * FROM skb_reservations WHERE status = 1 AND fast_track = 1 AND assigned = 1";
