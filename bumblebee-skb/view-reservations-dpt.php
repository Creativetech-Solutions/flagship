...
$reservationQuery = "SELECT * FROM skb_reservations  WHERE ( fast_track = 0 OR ftnotify = 1) AND status = 1";
                                    ...
                                    <table id="res-arrivals" class="table table-hover display">
                                        ...
                                        <?php
                                            while($row = mysql_fetch_array($reservations)) {
                                                ...
                                                $flight_class = mysql_fetch_row(mysql_query("SELECT * FROM skb_flightclass WHERE id='" . $row[55] . "'"));
                                                ...
                                                $dpt_dropoff = mysql_fetch_row(mysql_query("SELECT * FROM skb_location WHERE id_location='" . $row[33] . "'"));

                                                $transport_mode = mysql_fetch_row(mysql_query("SELECT * FROM skb_transporttype WHERE id='" . $row[29] . "'"));

                                                $driver = mysql_fetch_row(mysql_query("SELECT * FROM skb_transport WHERE id_transport='" . $row[30] . "'"));
