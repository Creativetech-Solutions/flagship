...
class SelectList
{
    protected $connd;
        ...
        public function ShowRoomType()
        {
            ...
            $sql = "SELECT * FROM skb_room_loc INNER JOIN skb_roomtypes WHERE skb_room_loc.id_location=$_POST[locationid] and
                 skb_room_loc.id_roomtype=skb_roomtypes.id_room ORDER BY skb_roomtypes.room_type ASC";
