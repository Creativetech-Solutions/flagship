...
$reservation_id = $_GET['reservation'];
$reservation = mysql_fetch_row(mysql_query("SELECT * FROM skb_transfer WHERE id='" . QuoteSmart($_GET['transfer_id']) . "'"));
$get_transfer_pickup = mysql_fetch_row(mysql_query("SELECT * FROM skb_location WHERE id_location='" . $reservation[2] . "'"));
$get_transfer_time = mysql_fetch_row(mysql_query("SELECT * FROM skb_flighttime WHERE id_fltime='" . $reservation[4] . "'"));  
$get_transfer_dropoff = mysql_fetch_row(mysql_query("SELECT * FROM skb_location WHERE id_location='" . $reservation[5] . "'")); 
$get_transfer_vehicle = mysql_fetch_row(mysql_query("SELECT * FROM skb_vehicles WHERE id_vehicle='" . $reservation[7] ."'")); 
$get_transfer_driver = mysql_fetch_row(mysql_query("SELECT * FROM skb_transport WHERE id_transport='" . $reservation[8] . "'"));
$flagship_ref = $reservation[1];

$pickupselect = mysql_query("SELECT * FROM skb_location ORDER BY name ASC");
$dropoffselect = mysql_query("SELECT * FROM skb_location ORDER BY name ASC");
