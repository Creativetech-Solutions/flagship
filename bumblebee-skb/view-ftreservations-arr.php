...
$reservationQuery = "SELECT * FROM skb_reservations R INNER JOIN skb_arrivals A on R.ref_no_sys = A.ref_no_sys WHERE (R.fast_track = 1 OR A.fast_track = 1) AND R.status = 1";
