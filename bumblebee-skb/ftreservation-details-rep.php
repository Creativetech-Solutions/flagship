...
$reservation = mysql_fetch_array(mysql_query("SELECT * FROM skb_reservations WHERE id='" . QuoteSmart($_GET['id']) . "' AND fast_track = 1"));
/*echo '<pre>';
print_r($reservation);
exit;*/
...
$queryRepTypes = "SELECT * FROM skb_rep_services WHERE section = 1 OR section = 2";
