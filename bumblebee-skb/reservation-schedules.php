...
//$reservations = mysql_query("SELECT * FROM skb_reservations WHERE status = 1 AND assigned = 1");

//Grab all reservation info
$reservationQuery = "SELECT * FROM skb_reservations WHERE status = 1 AND assigned = 1";
