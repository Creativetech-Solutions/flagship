                            ...
                            <div class="panel panel-default">
                                ...
                                <div class="panel-body">                                                                        
                                    ...
                                    <div class="form-group pull-left" style="width:100%;padding:0 12px">
                                         <span class="pull-left"><span class="adult_count">0</span> Adults @ </span>
                                        <input type="number" min=0 class="left20 form-control pull-left" id="price" value="<?=$amount?>"
                                               name="supplier_price" placeholder="Price" style="width:20%">&nbsp;  &nbsp;
                                              <span class="pull-left" style="padding:0 12px"> = </span>
                                        <input type="text" class="form-control" id="total_amount"
                                               name="total_amount"  placeholder="Total Amount" readonly style="background-color:white;color: black;float:left;width:25%"> 
                                    </div>
                                    <hr />
