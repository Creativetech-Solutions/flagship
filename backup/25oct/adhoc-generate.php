...
/*if(strpos($selectData, 'Reps')){
    $query .= ' LEFT JOIN bgi_reps RE on R.rep = RE.id_rep';
}*/
...
if(isset($TotalRows) and $TotalRows > 0){
    ...
    $reservationCols = ['GH','Id','Title_Name','First_Name','Last_Name','Guest_Email','Guest_Cell','PNR','Arrival_Service_Only','Client','Tour_Operator','Operator_Code','Reference_No','Adult','Child','Infant','A_C_I','Tour_Notes','Reps','Payment_Type'];
