 ...
 */
	...
	$sql = "UPDATE bgi_reservations ". 
        "SET title_name = '$title_name', first_name = '$first_name', last_name = '$last_name', pnr = '$pnr', tour_operator = '$tour_oper', operator_code = '$oper_code', tour_ref_no = '$tour_ref_no', adult = '$adults',teen='$teens', child = '$children', infant = '$infants', tour_notes = '$tour_notes', modified_date = NOW(), modified_by = '$loggedinas', status = '$res_status'". 
