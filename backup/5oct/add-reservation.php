...
//    var_dump($arrivals_transport_sql);
  ...
  /*  if(isset($_POST['arr1_transport'])) {

        $arr1_transport_mode = $_POST['arr1_transport'];
        $arr1_driver = $_POST['arr_driver1'];
        $arr1_vehicle_no = $_POST['arr_vehicle_no1'];
    }*/
...
//                'luggage_vehicle' => $arr3_luggage_vehicle_no[$key]
    ...
    $dpt1_transport         = !empty($_POST['dpt1_transport'])?QuoteSmart($_POST['dpt1_transport']):'';
                                ...
                                <div class="panel-body">                                                                        
                                    ...
                                    <div class="form-group">                                         
                                            <div class="form-inline col-xs-10"><!-- number of persons traveling -->
			                                    <input type="number" min=0 max=99 class="form-control" id="adults" name="adults" value="" placeholder="Select # of Adults" style="width:150px"> Adult(s): Above 17yrs &nbsp;&nbsp;&nbsp;
                                                <input type="number" min=0 max=99 class="form-control" id="teen" name="teen" value="" placeholder="Select # of Teens" style="width:150px"> Teen(s): 12 yrs – 17 yrs                                        
                                            </div>                          
                                            <div class="form-inline col-xs-10">
                                                <input type="number" min=0 max=99 class="left20 form-control" id="children" name="children" value="" placeholder="Select # of Children" style="width:150px"> Children: 13 months - 11yrs
                                                <input type="number" min=0 max=99 class="left20 form-control" id="infants" name="infants" value="" placeholder="Select # of Infants" style="width:150px"> Infant(s): 12 months and under                                       
                                            </div>        
                                    </div>
                                    <div class="form-group">
                                        <div class="col-xs-7">                                            
